...
function AddTask({onAddTaskSubmit}){
    ...
    <div className="space-y-4 p-6 bg-slate-200 rounded-md shadow flex flex-col">
        <input text="text" placeholder="Digite o titulo da tarefa" className="border border-slate-300 outline-slate-400 px-4 py-2 rounded-md" 
        value={title} onChange={(event) => setTitle(event.target.value)}></input>


        <input text="text" placeholder="Digite a descricao da tarefa" className="border border-slate-300 outline-slate-400 px-4 py-2 rounded-md" 
